...
namespace Job_Assignment
{
    public partial class Form1 : SQL_APPL
    {
        ...
        public string Tracking_View_Select_CMD = @"SELECT * FROM [R_001_Tracking_View] ";
        public string Tracking_View_Init_Database_CMD = @"SELECT * FROM [R_001_Tracking_View]
                      WHERE Date = ''";
        ...
        private bool Tracking_View_Init()
        {
            ...
            {
                if (tabControl1.TabPages.Contains(Tracking_View_MasterDatabase.MasterDatabase_Tab) == false)
                {
                    tabControl1.TabPages.Insert(tabControl1.TabPages.Count, Tracking_View_MasterDatabase.MasterDatabase_Tab);
                }
                tabControl1.SelectTab("Tracking_View");
                return true;
            }
            Tracking_View_Exist = true;
            // Init_Line_Desciption_Excel();
            Tracking_View_MasterDatabase = new MaterDatabase(OpenXL, tabControl1, "Tracking_View", 0, MasterDatabase_Connection_Str, 
            ...
            //set role
            string moduleId = "R_001";
            RoleHelper.SetRole(Tracking_View_MasterDatabase, moduleId);
