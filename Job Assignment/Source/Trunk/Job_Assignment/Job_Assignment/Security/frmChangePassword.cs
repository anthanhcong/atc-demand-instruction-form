...
namespace Job_Assignment
{
    public partial class frmChangePassword : Form
    {
        ...
        private void btOK_Click(object sender, EventArgs e)
        {
            ...
            {
                //err = security.ResetPassword(tbUserId.Text, tbNewPassword.Text);
                string hashOldPassword = HashHelper.computeHash(tbOldPassword.Text);

                if (hashOldPassword != ApplicationSession.UserLoginInfo.Password)
