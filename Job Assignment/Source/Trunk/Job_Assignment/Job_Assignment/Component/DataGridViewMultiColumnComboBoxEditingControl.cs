...
namespace MasterDatabase
{
    ...
    public class DataGridViewMultiColumnComboBoxEditingControl : DataGridViewComboBoxEditingControl
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:DGMCCBD.Controls.DataGridViewMultiColumnComboBoxEditingControl"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the LinkedColumnName
        /// </summary>
        [DefaultValue("")]
        ...
        /// </summary>
        [DefaultValue(null)]
        public int? LinkedColumnIndex { get; set; }
        ...
        {
            object obj = base.GetEditingControlFormattedValue(context);
            return obj;
        }
     ...
     //       message.Text = String.Format("SelectedIndex: {0}, SelectionStart: {1}, SelectionLength: {2}, DropDownStyle: {3}", SelectedIndex, SelectionStart, SelectionLength, DropDownStyle);
