...
namespace JobsDisplay
{
    public partial class Form1 : SQL_APPL
    {
        ...
        private bool LoadInternalData()
        {
            ...
            {
                ret = dao.OpenDataTable(MasterDatabase_Connection_Str, ref _empAndSkillList, CommandType.Text, EmpAndSkill_DB_Cmd);
            }

            if (_WstAndSkillList == null)
            {
                ret = dao.OpenDataTable(MasterDatabase_Connection_Str, ref _WstAndSkillList, CommandType.Text, WstAndSkill_DB_Cmd);
            }
