...
namespace JobsDisplay
{
    public class MSSqlDbFactory
    {
        ...
        public String ExecuteNonQuery(string connString, CommandType cmdType, string cmd_str, params object[] parameters)
        {
        ...
        public DataTable Get_SQL_Data(string connString, string cmd_str, ref SqlDataAdapter dataAdapter)
        {
            DataTable dtbTmp = new DataTable();
            DataSet input_dataset = new DataSet();
